...
export const createMessage = (project_id: string, text: string, question: string, options: any, user: any) => async (dispatch: AppDispatch) => {
  try {
...
export const getMessages = (project_id: string) => async (dispatch: AppDispatch) => {
  try {
    dispatch(setLoading());
...
export const setPoolVote = (project_id: string, message_id: string, firstname: string, lastname: string, email: string, color: string, poll_id: string, option_id: string) => async (dispatch: AppDispatch) => {
  try {
...
export const deletePoolVote = (project_id: string, message_id: string, email: string, poll_id: string, option_id: string) => async (dispatch: AppDispatch) => {
  try {
...
export const sendReply = (project_id: string, message_id: string, text: string) => async (dispatch: AppDispatch) => {
  try {
...
export const getAllReplies = (project_id: string) => async (dispatch: AppDispatch) => {
  try {
