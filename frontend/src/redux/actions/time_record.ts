...
export const createTimeRecord = (start: any, end: any, task_id: string, total: number, project_id: string) => async (dispatch: AppDispatch) => {
  try {
...
export const getTimeRecords = (project_id: string) => async (dispatch: AppDispatch) => {
  try {
...
export const getMemberRecords = (project_id: string, id: string) => async (dispatch: AppDispatch) => {
  try {
...
export const getTimeRecordsSum = (project_id: string) => async (dispatch: AppDispatch) => {
  try {
